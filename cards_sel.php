	...
	<div class="payment">
		...
		<div class="form">
			...
			<br>
				...
				<input type="text" class="input" name="card_holder" placeholder="Holder Name" required="True">
				<i class="fas fa-user"></i></div>

			<div class="card space icon-relative">
				<label class="label">Card number:</label>
				<input type="text" class="input" name="card_number" placeholder="Card Number" data-mask="0000 0000 0000 0000" required>
				<i class="far fa-credit-card"></i>
			</div>
			<div class="card space icon-relative">
				<label class="label">Expiry Data:</label>
				<input type="month" class="input" name="expiry_date" min="2021-12" max="2023-12" required>
			...
			<br>
			    <label class="label">Card holder:</label>
				<input type="text" class="input" name="card_holder" placeholder="Holder Name" required>
			...
			<div class="card space icon-relative">
	            ...
	            <div class="card space icon-relative">
	        	<label class="label">CVC:</label>
		        <input type="text" class="input form-control" name="cvc" placeholder="000" data-mask="000" required>
		        <i class="fas fa-lock"></i>
	            </div>
            </div>
                </div>	
