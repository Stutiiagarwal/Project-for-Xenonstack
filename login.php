...
<body>
    <div class="header">
        <div class="inner-header">
            <div class = "header-link"> <a href="menu.php">Menu</a> </div>              
	...
	<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-_KKqeIL6GZxCM9nR6sBwjOF7gIGh0uRR0g&usqp=CAU"/>
        ...
        <form action="login_submit.php" method="post">
            ...
            <div class="form-group">
            <input type="password" class="form-control" id="password" name="password" placeholder="Password" required pattern=".{6,}"   required title="6 characters minimum">
	    </div>
